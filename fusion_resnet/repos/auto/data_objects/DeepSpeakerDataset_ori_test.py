...
class DeepSpeakerDataset(data.Dataset):
    ...
    def __init__(self, data_dir, sub_dir, partial_n_frames, partition=None, is_test=False):
        ...
        self.speakers = [Speaker(speaker_dir, self.partition)
        ...
        print("{} num of spks:{} features:{}".format(
            str(partition), len(self.speakers), len(self.features)))
    ...
    def __getitem__(self, index):
        ...
        return feature, speaker_id,{feature_path:[]}
